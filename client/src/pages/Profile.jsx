    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      {userListings && userListings.length > 0 && (
        <div className="flex flex-col gap-4 text-sm">
          <h1 className="text-center font-semibold text-2xl mt-5 uppercase">
            Your Listings
          </h1>
          {userListings.map((listing) => (
            <div
              key={listing._id}
              className="flex border rounded-lg p-3 gap-3 justify-between items-center"
            >
              ...
              <Link
                className="text-slate-700 text-sm font-semibold flex-1 hover:underline truncate"
